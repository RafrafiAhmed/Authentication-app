...
var routes = [
    ...
    { path: 'dashboard', component: __WEBPACK_IMPORTED_MODULE_6__dashboard_dashboard_component__["a" /* DashboardComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_2__auth_guard_service__["a" /* AuthGuard */]] },
    { path: 'login', component: __WEBPACK_IMPORTED_MODULE_4__login_login_component__["a" /* LoginComponent */] },
    { path: 'register', component: __WEBPACK_IMPORTED_MODULE_3__register_register_component__["a" /* RegisterComponent */] },
    { path: 'profile', component: __WEBPACK_IMPORTED_MODULE_7__profile_profile_component__["a" /* ProfileComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_2__auth_guard_service__["a" /* AuthGuard */]] },
];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__auth_module__ = __webpack_require__("../../../../../src/app/auth.module.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_8__auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_7__auth_guard_service__["a" /* AuthGuard */]],
...
var AuthService = (function () {
    ...
    AuthService.prototype.getRegister = function (newUser) {
        return this.http
    ...
    AuthService.prototype.getAuthenticate = function (username, password) {
        return this.http
            .post(this.apiUrl + "auth/", JSON.stringify({ username: username, password: password }), { headers: this.headers })
            .toPromise()
            .then(function (res) { return res.json(); })
            .catch(this.handleError);
    };
    ...
    AuthService.prototype.update = function (id, obj) {
        return this.http.put("http://localhost:3000/api/update/profile/" + id, obj);
    };
...
module.exports = "<h1>You can sign up or login</h1>\n "
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService
            ...
            if (data.success === false) {
                _this.flashMessagesService.show("Something went wrong! Details: " + data.msg, { cssClass: 'alert-danger', timeout: 6000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.authService.authUser = data.user;
                _this.authService.authToken = data.token;
...
LoginComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__auth_service__["a" /* AuthService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2_angular2_flash_messages__["FlashMessagesService"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_angular2_flash_messages__["FlashMessagesService"]) === "function" && _c || Object])
], LoginComponent);
...
module.exports = "<nav class=\"navbar navbar-default\">\n  <div class=\"container-fluid\">\n    <!-- <div class=\"navbar-header\">\n      <button type=\"button\" class=\"navbar-toggle collapsed\" data-toggle=\"collapse\" data-target=\"#navbar\" aria-expanded=\"false\" aria-controls=\"navbar\">\n        <span class=\"sr-only\">Toggle</span>\n        <span class=\"icon-bar\"></span>\n        <span class=\"icon-bar\"></span>\n        <span class=\"icon-bar\"></span>\n      </button>\n      <a class=\"navbar-brand\" routerLink=\"/\">Basic MEAN Login</a>\n    </div> -->\n    <div id=\"navbar\" class=\"navbar-collapse collapse\">\n      <ul class=\"nav navbar-nav\">\n        <!-- <li routerLinkActive=\"active\">\n          <a routerLink=\"/home\">Home</a>\n        </li> -->\n        <!-- <li routerLinkActive=\"active\" *ngIf=\"auth.isLoggedIn()\"> \n          <a routerLink=\"/dashboard\">Dashboard</a>\n        </li> -->\n        <li routerLinkActive=\"active\" *ngIf=\"!auth.isLoggedIn()\">\n          <a routerLink=\"/login\">Login</a>\n        </li>\n        <li routerLinkActive=\"active\" *ngIf=\"!auth.isLoggedIn()\">\n          <a routerLink=\"/register\">Register</a>\n        </li>\n        <li routerLinkActive=\"active\" *ngIf=\"auth.isLoggedIn()\">\n          <a routerLink=\"/profile\">Profile</a>\n        </li>\n        <li routerLinkActive=\"active\" *ngIf=\"auth.isLoggedIn()\">\n          <a (click)=\"onLogoutClick(); $event.stopPropagation();\" href=\"#\">Logout</a>\n        </li>\n      </ul>\n    </div>\n  </div>\n</nav>\n"
...
var ProfileComponent = (function () {
    function ProfileComponent(router, authService, flashMessagesService) {
        this.router = router;
        this.authService = authService;
        this.flashMessagesService = flashMessagesService;
    }
    ProfileComponent.prototype.ngOnInit = function () {
        ...
        this.authService
            ...
            if (!data.success) {
                _this.flashMessagesService.show("Something went wrong!", { cssClass: 'alert-danger', timeout: 6000 });
                _this.router.navigate(['/login']);
            }
        });
    };
    ...
    ProfileComponent.prototype.updateProfile = function (f) {
        var _this = this;
        ...
        console.log(obj);
        this.authService.update(id, obj).subscribe(function () {
            _this.authService
                .getProfile()
                .then(function (data) {
                console.log(data.user);
...
module.exports = "<div class=\"row\">\n  <div class=\"col-md-6\">\n    <h2 class=\"page-header\">Sign Up</h2>\n      <form #userForm=\"ngForm\" (submit)=\"onRegisterSubmit()\">\n      <div class=\"form-group\">\n        <label for=\"username\">Username</label>\n        <input type=\"text\" class=\"form-control\" name=\"username\" \n          id=\"username\" placeholder=\"username\" required=\"true\"\n           [(ngModel)]=\"user.username\" #username=\"ngModel\">\n        <div [hidden]=\"username.valid || username.pristine\"\n          class=\"alert alert-danger\">\n            Username is required\n        </div>\n      </div>\n      <div class=\"form-group\">\n        <label for=\"firstName\">First Name</label>\n        <input type=\"text\" class=\"form-control\" name=\"firstName\"\n           id=\"firstName\" placeholder=\"first name\" required=\"true\"\n           [(ngModel)]=\"user.firstName\" #firstName=\"ngModel\">\n        <div [hidden]=\"firstName.valid || firstName.pristine\"\n          class=\"alert alert-danger\">\n            First name is required\n        </div>\n      </div>\n      <div class=\"form-group\">\n        <label for=\"lastName\">Last Name</label>\n        <input type=\"text\" class=\"form-control\" name=\"lastName\"\n           id=\"lastName\" placeholder=\"last name\" required=\"true\"\n           [(ngModel)]=\"user.lastName\" #lastName=\"ngModel\">\n        <div [hidden]=\"lastName.valid || lastName.pristine\"\n          class=\"alert alert-danger\">\n            Last name is required\n        </div>\n      </div>\n      <div class=\"form-group\">\n        <label for=\"email\">Email</label>\n        <input type=\"text\" class=\"form-control\" name=\"email\"\n           id=\"email\" placeholder=\"name@example.com\" required=\"true\"\n           [(ngModel)]=\"user.email\" #email=\"ngModel\">\n        <div [hidden]=\"email.valid || email.pristine\"\n          class=\"alert alert-danger\">\n            Email is required\n        </div>\n      </div>\n      <div class=\"form-group\">\n        <label for=\"password\">Password</label>\n        <input type=\"password\" class=\"form-control\" name=\"password\"\n           id=\"password\" placeholder=\"password\" required=\"true\"\n           [(ngModel)]=\"user.password\" #password=\"ngModel\">\n        <div [hidden]=\"password.valid || password.pristine\"\n          class=\"alert alert-danger\">\n            Password is required\n        </div>\n      </div>\n      <button type=\"submit\" class=\"btn btn-primary\"\n        [disabled]=\"!userForm.form.valid\">Register Me</button>\n    </form>\n  </div>\n</div>\n"
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService
            ...
            if (data.success === false) {
                ...
                _this.flashMessagesService.show("You're now registered! Please, login.", { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
        });
    };
